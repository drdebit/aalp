...
ITEMS = [
    ...
    {"id": "aa9", "tag": "aa:novel-transfer", "pre": True,
     "q": "A new situation you have not seen: the business pays a freelance designer $400 for a logo design that it will print on shirts. How would you record it — what statements would you make about the event — and what do you think the journal entry would be? Say what you are unsure about.",
     "rubric": "1 pt: the business provides $400 money and receives something (a design / intellectual property / a service) from a counterparty — the event is described by what went out and what came in, not by naming an account first. 1 pt: a defensible entry (debit an asset such as Design/IP, or an expense, $400; credit Cash $400) with an honest, specific statement of the uncertainty (asset vs expense, or how the design's cost flows into shirts)."},
