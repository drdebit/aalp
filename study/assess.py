...
ITEMS = [
    ...
    {"id": "aa3", "tag": "aa:allows-role", "pre": False,
     "q": "The same printer could be Equipment for SP and Inventory for a shop that resells printers. Which assertion told the record which one it was, and why does the reseller's printer come out differently?",
     "rubric": "1 pt: the 'allows' assertion — saying what the printer is for (turns blank shirts and ink into printed ones). 1 pt: the reseller never says the printer makes anything (no allows; it is bought to be sold on), so the record has no reason to call it equipment — it is what the record says about the thing, not the thing itself, that decides; 'not yet classified' / inventory."},
